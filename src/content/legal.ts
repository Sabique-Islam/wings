...
export const LEGAL_DOCS: Record<LegalDoc["slug"], LegalDoc> = {
  privacy: {
    ...
    sections: [
      ...
      { h: "legal bases (GDPR art. 6)", p: "Contract: to provide the editor, sync, and sharing features you signed up for. Legitimate interest: to keep the service secure, prevent abuse, and debug errors. Consent: for any optional analytics or marketing cookies, which are off by default and stored locally." },
  ...
  cookies: {
    ...
    description: `Cookie policy for ${SITE.brand}. One essential session cookie. Everything else is opt-in and stored locally.`,
    sections: [
      ...
      { h: "analytics", p: "Off by default. If enabled via the consent banner, we may load privacy-respecting product analytics to count active features. No cross-site identifiers." },
